...
final class Logo extends Setting {
     ...
     * @access private
     * 
     * @var GrottoPress\Jentil\Setup\Customizer\Logo\Logo $logo Logo section.
     */
    private $logo;
     ...
     * Constructor
     * 
     * @param GrottoPress\Jentil\Setup\Customizer\Logo\Logo $logo Logo section.
     *
     * @since 0.1.0
     * @access public
     */
    ...
    private function set_control() {
        $size = $this->logo->customizer()->jentil()->utilities()->logo()->size();
