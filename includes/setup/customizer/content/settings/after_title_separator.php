 ...
 * @since			Jentil 0.1.0
 */
class After_Title_Separator extends Customizer\Setting {
    /**
     * Content section
     *
     * @since       Jentil 0.1.0
	...
	public function __construct( $content ) {
        ...
        $this->name = sanitize_key( $this->content->get( 'name' ) . '_after_title_separator' );
        $this->args = array(
            'default' => ' | ',
        ...
        $this->control = array(
            ...
            'label' => esc_html__( 'After title separator', 'jentil' ),
            'type' => 'text',
        );
	}
}